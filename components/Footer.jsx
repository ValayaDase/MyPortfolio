...
import { FaLinkedinIn, FaGithub, FaTwitter, FaArrowUp, FaInstagram } from "react-icons/fa";
...
export default function Footer() {
  ...
  return (
    <footer
      ref={footerRef}
      className="relative bg-[#030303] pt-32 pb-8 overflow-hidden border-t border-white/5"
    >
      {/* Background Glow */}
        ...
        <div className="flex flex-col lg:flex-row justify-between items-start lg:items-end gap-16">
          ...
          <div className="max-w-lg">
            ...
            <p className="footer-top-reveal text-white/40 text-lg mb-8 leading-relaxed">
              Open for freelance opportunities, collaborations, and building the
          ...
          <div className="flex flex-col gap-6">
            <p className="footer-top-reveal font-mono text-xs uppercase tracking-[0.3em] text-white/30 mb-2">
              Connect
            </p>
              ...
              {[
                {
                  ...
                  link: "https://www.linkedin.com/in/valaya-dase-9b17a8331/",
                },
                {
                  icon: <FaGithub size={20} />,
                  link: "https://github.com/ValayaDase",
                },
                { icon: <FaInstagram size={20} />, link: "https://www.instagram.com/_valaya_.02" },
              ].map((social, i) => (
                <a
                  key={i}
                  href={social.link}
      ...
      <div
        ref={nameTrackRef}
        className="max-w-7xl mx-auto px-6 w-full relative overflow-hidden"
        style={{ minHeight: "clamp(80px, 15vw, 200px)" }}
      >
        {/* 
                    Scooter Container: 
        ...
        <div
          ref={nameRevealRef}
          className="w-full flex justify-between items-center whitespace-nowrap tracking-[-0.02em]"
        ...
        >
          {name.split("").map((char, index) => (
            <span
              ...
              onMouseEnter={(e) => {
                // Generates only the blue neon aura directly behind the letter
                e.currentTarget.style.textShadow = "0 0 35px rgba(59, 130, 246, 0.85), 0 0 10px rgba(59, 130, 246, 0.4)";
              }}
              onMouseLeave={(e) => {
                // Instantly kills the shadow glow when leaving the character bounds
      ...
      <div className="max-w-7xl mx-auto px-6 w-full">
        <div className="flex flex-col md:flex-row justify-between items-center gap-6">
          ...
          >
            <span className="font-mono text-[10px] uppercase tracking-widest text-white/50 group-hover:text-white">
              Back to Top
            </span>
